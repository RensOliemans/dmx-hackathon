...
dmx.set_channel(129,255)
dmx.set_channel(130,255)
dmx.set_channel(131,255)

dmx.set_channel(480,255)
dmx.set_channel(481,255)
dmx.set_channel(482,255)

dmx.set_channel(485,10)
dmx.make_frame()
dmx.make_frame()
'''
for i in range(500):
